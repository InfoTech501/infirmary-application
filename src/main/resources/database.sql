...
alter table patient
    ...
    foreign key (student_number) references student;
...
insert into patient (patient_id, student_number, first_name, middle_name, last_name, symptoms, added_remarks, temperature_readings, visit_date, time_in, time_out, medications_administered, nurse_in_charge)
values ('001', 'TCSNHS-0011', 'Kim Yashai', 'Legaspi', 'Panlilio', 'headache', 'consider further neurological evaluation', '36.5 C', TO_TIMESTAMP('2025-01-03 00:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), TO_TIMESTAMP('2025-01-03 08:23:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'),  TO_TIMESTAMP('2025-01-03 12:23:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), 'Acetaminophen (Tylenol)', 'Nurse K');
insert into patient (patient_id, student_number, first_name, middle_name, last_name, symptoms, added_remarks, temperature_readings, visit_date, time_in, time_out, medications_administered, nurse_in_charge)
values ('002', 'TCSNHS-0022', 'John', 'Cruz', 'Doe', 'fever', 'none', '38.6 C', TO_TIMESTAMP('2025-02-01 00:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), TO_TIMESTAMP('2025-02-01 08:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'),  TO_TIMESTAMP('2025-02-01 11:23:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), 'Acetaminophen (Tylenol)', 'Nurse K');
insert into patient (patient_id, student_number, first_name, middle_name, last_name, symptoms, added_remarks, temperature_readings, visit_date, time_in, time_out, medications_administered, nurse_in_charge)
values ('003', 'TCSNHS-0033', 'kale', 'Angcanan', 'Bayot', 'cough', 'none', '36.5 C', TO_TIMESTAMP('2025-02-08 00:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), TO_TIMESTAMP('2025-02-08 07:23:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'),  TO_TIMESTAMP('2025-02-08 11:23:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), 'Acetaminophen (Tylenol)', 'Nurse K');
insert into patient (patient_id, student_number, first_name, middle_name, last_name, symptoms, added_remarks, temperature_readings, visit_date, time_in, time_out, medications_administered, nurse_in_charge)
values ('004', 'TCSNHS-0044', 'lei', 'Villanueva', 'Bayot', 'sore throat', 'none', '36.5 C', TO_TIMESTAMP('2025-01-03 00:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), TO_TIMESTAMP('2025-01-03 06:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'),  TO_TIMESTAMP('2025-01-03 10:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), 'Acetaminophen (Tylenol)', 'Nurse K');
insert into patient (patient_id, student_number, first_name, middle_name, last_name, symptoms, added_remarks, temperature_readings, visit_date, time_in, time_out, medications_administered, nurse_in_charge)
values ('005', 'TCSNHS-0055', 'joe', 'bill', 'Bayot', 'sore throat', 'none', '36.5 C', TO_TIMESTAMP('2025-03-03 00:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), TO_TIMESTAMP('2025-03-03 06:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'),  TO_TIMESTAMP('2025-03-03 10:00:00.00', 'yyyy-mm-dd hh24:mi:ss.ff'), 'Acetaminophen (Tylenol)', 'Nurse K');


-- REPORTS ON COMMON AILMENTS

--SELECT
--    p.symptoms AS ailment,
...
--WHERE
--    p.visit_date BETWEEN TO_TIMESTAMP(:start_date, 'YYYY-MM-DD HH24:MI:SS')
--    AND TO_TIMESTAMP(:end_date, 'YYYY-MM-DD HH24:MI:SS')
--    AND (s.grade_level = :grade_level OR :grade_level IS NULL)
--    AND (s.section = :section OR :section IS NULL)
--GROUP BY
--    p.symptoms,
--    s.first_name,
--    s.last_name,
