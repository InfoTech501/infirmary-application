...
public class MedicalRecords {
    ...
    private Integer nurseInChargeId;
    private transient String nurseInChargeName;
    ...
    public Integer getNurseInChargeId() {
        return nurseInChargeId;
    }

    public void setNurseInChargeId(Integer nurseInChargeId) {
        this.nurseInChargeId = nurseInChargeId;
    }

    public String getNurseInChargeName() {
        return nurseInChargeName;
    }

    public void setNurseInChargeName(String nurseInChargeName) {
        this.nurseInChargeName = nurseInChargeName;
    }
    ...
    public String toString() {
        return "MedicalRecords{" +
                ...
                ", nurseInChargeName='" + nurseInChargeName + '\'' +
                '}';
    }
}